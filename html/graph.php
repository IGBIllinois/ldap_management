...
if ( $_REQUEST['graph'] == 'usercal' ) {
    ...
    echo json_encode(array('data' => $calarray, 'years' => $maxYear-$minYear+1));
}
else if ( $_REQUEST['graph'] == "passcal" ) {
