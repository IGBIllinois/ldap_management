...
renderTwigTemplate('edit.html.twig', array(
    ...
    'header' => 'Add User',
    'inputs' => array(
        array('attr' => 'username', 'name' => 'Username', 'type' => 'text'),
        array('attr' => 'forwardingEmail', 'name' => 'Forwarding Email', 'type' => 'text'),
        array('attr' => 'firstName', 'name' => 'First Name', 'type' => 'text'),
        array('attr' => 'lastName', 'name' => 'Last Name', 'type' => 'text'),
        array('attr' => 'password', 'name' => 'Password', 'type' => 'password'),
        array('attr' => 'confirmPassword', 'name' => 'Confirm Password', 'type' => 'password'),
        array('attr' => 'realPerson', 'name' => 'Real Person', 'type' => 'checkbox', 'value' => true),
    ),
