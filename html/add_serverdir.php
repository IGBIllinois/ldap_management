...
?>
<div class="minijumbo"><div class="container">Add Server Directory to Group
	<?php if($gid != "") { ?>
	<nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="list_groups.php">Groups</a></li><li class="breadcrumb-item"><a href="group.php?gid=<?php echo $gid; ?>"><?php echo $gid; ?></a></li><li class="breadcrumb-item active">Add Server Directory</li></ol></nav>
	<?php } ?>
</div></div>
<div class="container">
...
<!-- 				TODO this must not contain a : -->
		...
		<div class="form-group row">
			<div class="col-sm-5 offset-sm-3">
				...
				<div class="btn-group">
					<input class="btn btn-success" type="submit" name="add_dir" value="Add directory" /> <input class="btn btn-light" type="submit" name="cancel_dir" value="Cancel" />
				</div>
			</div>
		</div>
	</fieldset>
