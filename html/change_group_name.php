...
?>
<div class="minijumbo"><div class="container">Change Group Name
	<?php if($gid != "") { ?>
	<nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="list_groups.php">Groups</a></li><li class="breadcrumb-item"><a href="group.php?gid=<?php echo $gid; ?>"><?php echo $gid; ?></a></li><li class="breadcrumb-item active">Change Name</li></ol></nav>
	<?php } ?>
</div></div>
<div class="container">
