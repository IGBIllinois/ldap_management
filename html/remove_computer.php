...
?>
<div class="minijumbo"><div class="container">Remove Domain Computer
	<?php if($uid != ""){ ?>
	<nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="list_computers.php">Domain Computers</a></li><li class="breadcrumb-item"><a href="computer.php?uid=<?php echo $uid; ?>"><?php echo $uid; ?></a></li><li class="breadcrumb-item active">Remove</li></ol></nav>
	<?php } ?>
</div></div>
<div class="container">
